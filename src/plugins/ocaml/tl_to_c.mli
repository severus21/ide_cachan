...
(** Convert a tl_ast to c_ast
    @param np namespace of the tl_ast(ie the path of the file)
    @param ast a tl_ast
    @return the c_ast related to ast with namespace np*)
val tl_ast_to_c_ast : string->Tl_ast.tl_ast->Core.Miscs.c_ast
